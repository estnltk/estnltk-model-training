...
vocabulary = [
    ...
    },
    {
        ...
        "_priority_": 1,
        "_validator_": lambda m: True,
        "value": lambda m: re.sub("\s?[.,]\s?", ".", m.group(0)),
    },
    {
        "grammar_symbol": "NUMBER",
    ...
    },
    {
        ...
        "_priority_": -2,
        "_validator_": lambda m: True,
        "value": lambda m: re.sub("\s?[.,]\s?", ".", m.group(4)),
    },
    {
        "grammar_symbol": "DATE",
        "regex_type": "date1",
    ...
    },
    {
        "grammar_symbol": "DATE",
        "regex_type": "date7",
        "_regex_pattern_": r"{DAY}\.\s?{MONTH}\s*k(el)?l\s{HOUR}[.:]{MINUTE}(:{SECOND})?".format(**substitutions),
        "_group_": 0,
        "_priority_": 3,
        "_validator_": lambda m: True,
        "value": lambda m: re.sub("\s?[.,]\s?", ".", m.group(0)),
