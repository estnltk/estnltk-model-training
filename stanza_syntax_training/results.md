...
|   1.13.0        | `UD_Estonian-EDT-r2.18`  | `morph_analysis`   |    No          |  0.8299   |  0.9043   | 0.0744  |
|   1.13.0        | `UD_Estonian-EDT-r2.18`  | `morph_extended`   |    No          |  0.8298   |  0.9099   | 0.0801  |
|   1.13.0        | `UD_Estonian-EDT-r2.18`  | `morph_extended`   |   10 models    |  0.8352   |  0.9203   | 0.0851  |
|   1.14.0        | `UD_Estonian-EDT-r2.18`  | `morph_analysis`   |    No          |  0.8326   |  0.9085   | 0.0759  |
|   1.14.0        | `UD_Estonian-EDT-r2.18`  | `morph_with_bert`  |    No          |  0.8432   |  0.9136   | 0.0704  |

_Note: the LAS score calculation excludes punctuation tokens._