from . import RobustDateNumberTagger
...
class MeasurementTokenTagger(Tagger):
    ...
    def __init__(
        ...
        gap_tagger = GapTagger(
            output_layer="gaps",
            input_layers=["dates_numbers", "measurement_objects", "units"],
        ...
        merge_tagger = MergeTagger(
            ...
            input_layers=["dates_numbers", "measurement_objects", "units", "gaps"],
            output_attributes=self.output_attributes,
        )

        self.tagger = SequentialTagger(taggers=[date_num_tagger, mo_tagger, unit_tagger, gap_tagger, merge_tagger])
