...
class RobustUnitTagger(Tagger):
    ...
    def __init__(
        ...
        for unit0, unit1 in base_units:
            regex_pattern = before + "(" + unit0 + ")" + after

            d = {
                "grammar_symbol": "DOSE_QUANTITY_UNIT",
        ...
        for unit0, unit1 in complex_units:
            unit2 = re.sub("/", " */ *", unit0)
        ...
        for unit0, unit1 in word_units:
            regex_pattern = unit0

            d = {
                "grammar_symbol": "RATE_QUANTITY_UNIT",
